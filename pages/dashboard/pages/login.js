...
const Home = () => {
  ...
  const [btnTxt, setBtnTxt] = useState("تسجيل الدخول كمدير");
  const [url, setUrl] = useState(`${baseUrl}/api/v1/admin_login/`);
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch(`${baseUrl}/api/v1/users/get-login-otp/`, {
      method: "POST",
      body: JSON.stringify({
        mobile,
        secret_attempted: password,
        user_type: UserType,
    ...
    data?.success === true
      ...
      : setError("كلمة المرور أو رقم الجوال غير صحيحان");
  ...
  const goToOtp = () => {
    ...
    router.push("/dashboard/pages/verifyOtp/")

  }
  // const saveUserInCookies = async (data) => {
  //   await Cookies.set("oboor_admin", JSON.stringify(data));
  //   console.log(data);
  //   if( data.user_type !== "ADM" ) {

  //     router.push("/dashboard/pages/purchases/")
  //   }
  //   else router.push("/dashboard/pages/dashboard");
  // };

  const chooseAdmin = () => {
    setBtnTxt("تسجيل الدخول كمدير");
    setActiveBg2("green");
    ...
    setUrl(`${baseUrl}/api/v1/admin_login/`);
  };
  ...
  const chooseAccountant = () => {
    ...
    setUrl(`${baseUrl}/api/v1/acc_login/`);
  };
  ...
  const chooseSalesEmployee = () => {
    ...
    setUrl(`${baseUrl}/api/v1/sale_admin_login/`);
  };
              ...
              <Row className='row-sm'>
                ...
                >
                  <div className='mt-4 p-2 pos-absolute'>
                    ...
                    <h5 className='mt-4 text-white'>سجل دخول الى حسابك</h5>
                    <span className='tx-white-6 tx-13 mb-5 mt-xl-0'>
                      سجل دخول الى حسابك لتتمكن من متابعة كل جديد على الموقع
                      خاصتك
                    </span>
                  </div>
                </Col>
                      ...
                      <Card.Body className='mt-2 mb-2'>
                        ...
                        <Form onSubmit={(e) => handleSubmit(e)}>
                          ...
                          <p className='mb-4 text-muted tx-13 ms-0 text-start'>
                            سجل دخول الى حسابك لتتمكن من متابعة كل جديد على
                            الموقع خاصتك
                          </p>
                          <Form.Group
                          ...
                          >
                            {loading ? "جار تسجيل الدخول..." : `${btnTxt}`}
                          </Button>
