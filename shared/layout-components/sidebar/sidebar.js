...
const SideBar = () => {
  ...
  //  In Horizontal When we click the body t should we Closed
          ...
          mainlevel.Items.filter((items) => {
            ...
            if (items.children) {
              items.children.filter((submenu) => {
                ...
                if (
                  location.pathname == "/dashboard/pages/product-detail/[id]" &&
                  submenu.path == "/dashboard/pages/product-details"
                ) {
                  items.active = true;
                  items.selected = true;
                  submenu.active = true;
          ...
          <div className='main-container-1 active main-sidebar-header'>
            ...
            >
              <div className='sidemenu-logo'>
                <Link className='main-logo' href={`/dashboard/pages/dashboard`}>
                  <img
                    src={logolight.src}
                  ...
                  {menuitems.map((Item, itemi) => (
                    <Fragment key={itemi + Math.random() * 100}>
                      <li className='nav-header'>
                        <span className='nav-label'>{ isAdmin === "sale" ? '' :Item.menutitle}</span>
                      </li>
                      {isAdmin === true 
                        ? Item.Items.map((menuItem, i) => (
                          menuItem.title != "المبيعات" && menuItem.title != "الطلبات المستلمة" && menuItem.title != "عمليات البيع" ?
                          <li
                            onClick={() => Outhover22()}
                        ...
                        : isAdmin !== true && isAdmin !== "sale" && itemi == 0
                          ? Item.Items.filter(menuItem =>
                            permissions?.some(permission => {
                              if (menuItem.title == 'الأحصائيات') {
                                return true;
                              }
                              else return permission.group_name == menuItem.title;
                            })
                          ).map((menuItem, i) => (
                            <li
                              onClick={() => Outhover22()}
                      ...
                      {
                        isAdmin === "sale" && itemi == 0 ?

                          Item.Items.slice(1, 2)
                                    ...
                                    {menuItem.children.map(
                                      (childrenItem, index) => {
                                        return (
                                          <li
                                            key={index}
                                            className={`nav-sub-item ${childrenItem.selected
                                              ? "active show"
                                              : ""
                                              }`}
                                          >
                                            ...
                                            {childrenItem.type === "link" ? (
                                              <Link
                                                ...
                                                className={`nav-sub-link ${menuItem.selected
                                                  ? " active"
                                                  : ""
                                                  }`}
                                              >
